    ...
    <style>
        * {
        ...
        .user-avatar {
            ...
            cursor: pointer;
            transition: var(--transition);
            pointer-events: none; /* Дозволяє клік проходити до батьківського dropdown-toggle */
        }
        ...
        @media (min-width: 992px) {
            ...
            /* Показуємо navbar-collapse на desktop */
            .navbar-collapse {
...
<body>
                ...
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <?php if (isLoggedIn()): ?>
                        ...
                        <li class="nav-item" style="position:relative;">
                            <button class="user-dropdown-btn" id="userDropdownBtn" type="button" onclick="toggleUserDropdown(event)">
                                <div class="user-avatar">
                                    <?= strtoupper(mb_substr($user['first_name'], 0, 1)) ?>
                                </div>
                                <?= htmlspecialchars($user['first_name']) ?>
                                <i class="fas fa-caret-down" style="margin-left:6px; font-size:12px;"></i>
                            </button>
    ...
    <!-- Bootstrap JS завантажується синхронно перед нашим скриптом -->
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>

    <script>
        /* ========== МОБІЛЬНЕ МЕНЮ — глобальні функції для onclick= ========== */
        ...
        function backToMainMenu() {
            var mm = document.getElementById('mobileMainMenu');
            var us = document.getElementById('userSubmenu');
            var mb = document.getElementById('mobileMenuBack');
            if (mm) mm.classList.remove('hidden');
            if (us) us.classList.remove('active');
            if (mb) mb.classList.remove('visible');
        }

        /* ========== ДЕСКТОП DROPDOWN — чистий JS, без Bootstrap ========== */
